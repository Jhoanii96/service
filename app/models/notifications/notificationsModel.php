...
class notificationModel extends Model{
  ...
  public function showNotifications($idUser){
    $query = "SELECT meu.Id_Mensaje_Usuario as Id,me.Titulo,me.Descripcion,meu.Leido FROM mensaje_usuario meu INNER JOIN mensaje me ON meu.Id_Mensaje = me.Id_Mensaje WHERE meu.Id_Usuario = $idUser ORDER BY meu.Fecha desc";
