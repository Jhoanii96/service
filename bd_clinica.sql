...
--
-- Estructura de tabla para la tabla `detalle_paciente_cuestionario`
--

CREATE TABLE `detalle_paciente_cuestionario` (
  `Id_Detalle_Paciente_Cuestionario` int(11) NOT NULL,
  `Id_Cuestionario` int(11) NOT NULL,
...
--
-- Indices de la tabla `detalle_paciente_cuestionario`
--
ALTER TABLE `detalle_paciente_cuestionario`
  ADD PRIMARY KEY (`Id_Detalle_Paciente_Cuestionario`);
...
--
ALTER TABLE `detalle_paciente_cuestionario`
  MODIFY `Id_Detalle_Paciente_Cuestionario` int(11) NOT NULL AUTO_INCREMENT;
