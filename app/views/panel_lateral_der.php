<div class="ui-theme-settings">
    <button type="button" id="TooltipDemo" class="btn-open-options btn btn-warning" style="line-height: 42px;left: -100px;bottom: 30px;height: 40px;width: 40px;">
        <i class="fa fa-cog fa-w-16" style="font-size: 1.3em;"></i>
    </button>
    <div class="theme-settings__inner">
        <div class="scrollbar-container">
            <div class="theme-settings__options-wrapper">
                <h3 class="themeoptions-heading">Opciones de diseño</h3>
                <div class="p-3">
                    <ul class="list-group">
                            ...
                            <div class="widget-content p-0">
                                <div class="widget-content-wrapper">
                                    ...
                                    <div class="widget-content-left">
                                        <div class="widget-heading">Encabezado fijo</div>
                                        <div class="widget-subheading">¡Hace que la parte superior del encabezado sea fija y siempre visible!</div>
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li class="list-group-item">
                            <div class="widget-content p-0">
                                <div class="widget-content-wrapper">
                                    ...
                                    <div class="widget-content-left">
                                        <div class="widget-heading">Barra lateral fija</div>
                                        <div class="widget-subheading">Hace que la barra lateral quede fija y siempre visible</div>
                                    </div>
                                </div>
                            </div>
                        </li>
                ...
                <div class="p-3">
                    <ul class="list-group">
                        <li class="list-group-item">
                            <h5 class="pb-2">Elegir esquema de color</h5>
                ...
                <h3 class="themeoptions-heading">
                    ...
                    <button type="button" class="btn-pill btn-shadow btn-wide ml-auto active btn btn-focus btn-sm">Predeterminado</button>
                </h3>
                <div class="p-3">
                    <ul class="list-group">
                        <li class="list-group-item">
                            <h5 class="pb-2">Pestañas de sección de página</h5>
                            <div class="theme-settings-swatches">
                                <div role="group" class="mt-2 btn-group">
                                    <button type="button" class="btn-wide btn-shadow btn-primary btn btn-secondary switch-theme-class" data-class="body-tabs-line"> Línea</button>
                                    <button type="button" class="btn-wide btn-shadow btn-primary active btn btn-secondary switch-theme-class" data-class="body-tabs-shadow"> Sombreado </button>
                                </div>
                            </div>
                        </li>
                        <li class="list-group-item">
                            <h5 class="pb-2">Esquemas de colores claros
                            </h5>
                            <div class="theme-settings-swatches">
                                <div role="group" class="mt-2 btn-group">
                                    <button type="button" class="btn-wide btn-shadow btn-primary active btn btn-secondary switch-theme-class" data-class="app-theme-white"> Tema blanco</button>
                                    <button type="button" class="btn-wide btn-shadow btn-primary btn btn-secondary switch-theme-class" data-class="app-theme-gray"> Tema gris</button>
                                </div>
                            </div>
                        </li>
                    </ul>
