...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-10-2020 a las 05:17:55
...
-- Procedimientos
--
CREATE DEFINER=`` PROCEDURE `actualizar_password` (IN `user` VARCHAR(60), IN `newpass` VARCHAR(50))  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `actualizar_perfil_cuenta` (IN `email` VARCHAR(200), IN `precio` DECIMAL(18,2), IN `link_image` VARCHAR(250), IN `username` VARCHAR(60), IN `isnotimage` VARCHAR(1))  BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `actualizar_perfil_personal` (IN `celphone1` VARCHAR(20), IN `celphone2` VARCHAR(20), IN `telefono1` VARCHAR(20), IN `telefono2` VARCHAR(20), IN `domicilio` VARCHAR(200), IN `username` VARCHAR(60))  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `actualizar_perfil_ubicacion` (IN `address` VARCHAR(200), IN `username` VARCHAR(60))  BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `insertar_cita_consulta` (IN `datecita` VARCHAR(15), IN `timecita` VARCHAR(15), IN `dnipaciente` VARCHAR(15), IN `username` VARCHAR(60))  BEGIN
...
CREATE DEFINER=``@`%` PROCEDURE `mostrar_archivo_historial` (IN `codhistory` INT, IN `tipo_archivo` INT, IN `user_name` VARCHAR(60))  BEGIN
...
(156, 'unnamed.jpg', 'unnamed.jpg', './src/assets/files/images/20090902310580305815996798653428.jpeg', 47566, '2020-09-09 14:31:05', NULL, 0, 1, NULL, 123, '1'),
(157, 'doom.jpg', 'doom.jpg', './src/assets/files/images/20090902310510002815996798653445.jpeg', 134122, '2020-09-09 14:31:05', NULL, 0, 1, NULL, 123, '1'),
(158, 'db_colegio2.0.png', 'db_colegio2.0.png', './src/assets/files/images/20090902310553426315996798653456.png', 134620, '2020-09-09 14:31:05', NULL, 0, 1, NULL, 123, '2'),
(159, 'dante-dmc.jpg', 'dante-dmc.jpg', './src/assets/files/images/20090902310529477215996798653469.jpeg', 651429, '2020-09-09 14:31:05', NULL, 0, 1, NULL, 123, '1'),
(160, 'DMC-Dante.jpg', 'DMC-Dante.jpg', './src/assets/files/images/20090902310555952015996798653487.jpeg', 14098, '2020-09-09 14:31:05', NULL, 0, 1, NULL, 123, '1'),
(161, 'kaguya.jpg', 'kaguya.jpg', './src/assets/files/images/20090902310536327315996798653519.jpeg', 78237, '2020-09-09 14:31:05', NULL, 0, 1, NULL, 123, '1'),
(162, 'doom.jpg', 'doom.jpg', './src/assets/files/images/20100907461547907615997851754448.jpeg', 134122, '2020-09-10 19:46:15', NULL, 0, 2, NULL, 125, '1'),
(163, 'db_colegio2.0.png', 'db_colegio2.0.png', './src/assets/files/images/20100907461583554015997851754658.png', 134620, '2020-09-10 19:46:15', NULL, 0, 2, NULL, 125, '2'),
(164, 'dante-dmc.jpg', 'dante-dmc.jpg', './src/assets/files/images/20100907461580815815997851754664.jpeg', 651429, '2020-09-10 19:46:15', NULL, 0, 2, NULL, 125, '1'),
(165, 'DMC-Dante.jpg', 'DMC-Dante.jpg', './src/assets/files/images/20100907461561539015997851754669.jpeg', 14098, '2020-09-10 19:46:15', NULL, 0, 2, NULL, 125, '1'),
(166, 'doom.jpg', 'doom.jpg', 'src/assets/files/images/20120906022616830415999517466201.jpeg', 134122, '2020-09-12 18:02:26', NULL, 0, 1, NULL, 128, '1'),
(167, 'dante-dmc.jpg', 'dante-dmc.jpg', 'src/assets/files/images/20120906022683408215999517466204.jpeg', 651429, '2020-09-12 18:02:26', NULL, 0, 1, NULL, 128, '1'),
(168, 'DMC-Dante.jpg', 'DMC-Dante.jpg', 'src/assets/files/images/20120906022686365015999517466208.jpeg', 14098, '2020-09-12 18:02:26', NULL, 0, 1, NULL, 128, '1');

--
-- Disparadores `archivo`
--
DELIMITER $$
CREATE TRIGGER `insert_espacio_usuario` AFTER INSERT ON `archivo` FOR EACH ROW BEGIN
...
INSERT INTO `ayuda` (`Id_Ayuda`, `Titulo`, `Descripcion`, `Fecha`, `Leido`, `arch_enlace`, `Id_Usuario`) VALUES
(1, '12345', '456454', '2020-10-11 21:50:59', 0, NULL, 1),
(2, '54654', '654654', '2020-10-11 22:06:58', 0, NULL, 1),
(3, '54654', '654654', '2020-10-11 22:08:18', 0, 'src/assets/files/images/help/20111010081760987016024720972324.jpeg', 1),
(4, '65468', '654654654', '2020-10-11 22:11:48', 0, 'src/assets/files/images/help/20111010114711725316024723071134.jpeg', 1),
(5, '1', 'askdjasdj', '2020-10-11 22:12:12', 0, 'src/assets/files/images/help/2011101012126295541602472332619.jpeg', 1),
(6, '1', 'askdjasdj', '2020-10-11 22:12:17', 0, 'src/assets/files/images/help/20111010121716911816024723376631.jpeg', 1),
(7, '6465', '654654', '2020-10-11 22:12:54', 0, 'src/assets/files/images/help/20111010125482533416024723746018.jpeg', 1);
...
(24, 2, 1, '2020-09-02 05:42:55', '2020-09-16 03:00:00', 4000, 0, 0, 0, 0),
(25, 2, 1, '2020-09-02 05:46:23', '2020-09-02 11:00:00', 4000, 0, 0, 0, 0),
(26, 2, 1, '2020-09-02 06:39:49', '2020-09-24 20:06:00', 4000, 0, 0, 0, 0),
(27, 2, 1, '2020-09-19 16:29:00', '2020-09-19 17:12:00', 20, 0, 0, 0, 0),
(28, 2, 5, '2020-09-20 00:19:50', '2020-09-19 15:00:00', 20, 0, 0, 0, 0);
...
(24, 1, '2020-07-17 01:18:08', 24, 0),
(26, 2, '2020-07-17 02:36:07', 3, 0),
...
INSERT INTO `detalle_cuestionario` (`Id_Detalle_Cuestionario`, `Id_Cuestionario`, `Pregunta`, `Mostrar`, `Nuevo`) VALUES
(22, 24, 'tabaco', 0, 0),
(95, 24, '123456', 0, 0),
(96, 24, '4548484', 0, 0),
(97, 24, 'pregunta 1', 0, 0),
(116, 26, 'SIDA', 1, 0),
(117, 24, 'TIENE TETANO', 0, 0),
(118, 24, 'FUMA', 0, 0),
(119, 24, 'PREGUNTA 3', 0, 0),
(120, 27, 'PREGUNTA 1', 1, 0),
(121, 27, 'PREGUNTA 2', 1, 0),
(122, 27, 'PREGUNTA 3', 1, 0),
(123, 27, 'PREGUNTA 4', 1, 0),
(124, 28, 'Pregunta1', 1, 0),
(125, 28, 'Pregunta 2', 1, 0),
(126, 28, 'Pregunta 3', 1, 0),
(127, 24, 'Tiene algún sintoma', 0, 0),
(128, 24, 'salutttte', 0, 0),
(129, 24, 'tienes cancer', 0, 0),
(130, 24, 'com lafam', 0, 0),
(131, 24, 'prros', 0, 0),
(132, 26, 'usaste condon prro', 1, 0),
(133, 26, 'aksjdalsdl', 1, 0),
(134, 24, 'tiene sida', 1, 0),
(135, 24, 'agua', 0, 1),
(136, 24, 'balas', 0, 1),
(137, 24, 'karr', 0, 1),
(138, 24, 'laksjdlkj', 0, 1),
(139, 24, 'por', 1, 1),
(140, 24, 'peliculas', 1, 1),
(141, 24, 'saluuuuute', 0, 1),
(142, 24, 'asjdijawoidjoiawjd', 0, 1),
(143, 24, 'tiene alguna enfermedad', 1, 1),
(144, 24, 'alguna sugerencia', 1, 1),
(145, 24, 'alkjdlakjds', 0, 1);
...
(321, 131, '2', 45, 0),
(322, 134, '4', 45, 1),
(323, 135, '54654654', 45, 0),
(325, 136, 'si', 45, 0),
(326, 136, 'no', 1, 0),
(327, 137, 'asddddd', 45, 0),
(328, 138, '12345', 45, 0),
(329, 135, 'si', 1, 1),
(331, 137, 'oooooo', 1, 1),
(332, 138, 'hhhh', 1, 0),
...
(2, 3, 1, 22, 157, 1426, '75744654', '198745', 'JHON', 'ALVARADO', 'ACHATA', NULL, 'M', '123546', '65465465', '654654', '65465', NULL, 'jhon_123_jw@outlook.es', NULL, NULL, NULL, '1996-01-27'),
...
INSERT INTO `historia_clinica` (`Id_historia_clinica`, `Id_Paciente`, `Id_Usuario`, `Id_Cita`, `Fecha`, `Anamnesis`, `Examenes`, `Examen_Fisico`, `Diagnostico`, `Tratamiento`, `Monto`) VALUES
(128, 31, 1, NULL, '2020-09-12 18:02:26', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'Debe tomar medicamento durante toda una semana y cagará camuflado :v', 30),
(129, 5, 1, NULL, '2020-09-10 18:33:33', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'Tomara pastillas durante todo un mes para evitar las alergias que tiene ', 30),
(130, 10, 1, NULL, '2020-09-09 18:11:02', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'Reposar en casita :\')', 30),
(131, 11, 1, NULL, '2020-08-07 18:12:19', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'descansar', 30),
(132, 1, 1, NULL, '2020-09-03 18:12:57', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'aijdlajslkdjalksdj', 30),
(133, 14, 1, NULL, '2020-09-12 18:13:48', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'tratamiento', 30),
(134, 1, 1, NULL, '2020-09-10 18:19:41', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'tratamiento', 30),
(135, 28, 1, NULL, '2020-09-10 18:20:34', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'tratamiento', 30),
(136, 1, 1, NULL, '2020-09-12 18:21:04', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'tratamiento', 30),
(137, 1, 1, NULL, '2020-09-07 18:21:32', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'tratamiento', 30),
(138, 5, 1, NULL, '2020-09-05 18:22:13', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'tratamiento', 30),
(139, 14, 1, NULL, '2020-05-04 18:22:46', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'asdasdasd', 30),
(140, 1, 1, NULL, '2020-09-03 18:23:21', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'costo', 30),
(141, 44, 1, NULL, '2020-09-13 20:03:53', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'tratamiento', 30),
(142, 45, 1, NULL, '2020-09-16 17:36:04', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'lakdskjahsdkj', 30),
(143, 45, 1, NULL, '2020-09-16 17:37:06', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'asdasd', 30),
(144, 45, 1, NULL, '2020-09-16 19:03:17', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'lasjdajsdl', 30),
(145, 45, 1, NULL, '2020-09-16 19:04:47', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'ssss', 30),
(146, 29, 1, NULL, '2020-09-16 19:11:52', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'lasdjkalsd', 30),
(147, 29, 1, NULL, '2020-09-16 19:16:14', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'awawdawd', 30),
(148, 29, 1, NULL, '2020-09-16 19:38:00', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'asdasd', 30),
(149, 45, 1, NULL, '2020-09-16 19:39:57', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'akjdhkajdh', 30),
(150, 45, 1, NULL, '2020-09-16 19:41:14', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'laksjdlkajsd', 30),
(151, 29, 1, NULL, '2020-09-16 20:02:53', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'akjdhkajsdh', 30),
(152, 29, 1, NULL, '2020-09-16 20:08:33', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'lakjdlkasjldk', 30),
(153, 45, 1, NULL, '2020-09-16 20:14:58', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'askjdlakd', 30),
(154, 1, 2, NULL, '2020-09-19 11:28:49', 'kasdhkjah\nalsjdalk\nadasdasdasd', 'saluuute', 'alsjdlkasjdlk\nslkjdlaksdj', 'nnbbn', '654654654', 20),
(155, 5, 2, NULL, '2020-09-19 19:19:41', 'kasdhkjah\nalsjdalk\nadasdasdasd', 'saluuute', 'alsjdlkasjdlk\nslkjdlaksdj', 'sss', '654654654', 20),
(156, 5, 2, NULL, '2020-09-19 19:48:11', 'kasdhkjah\nalsjdalk\nadasdasdasd', 'saluuute', 'alsjdlkasjdlk\nslkjdlaksdj', 'dsdasda', '654654654', 60.5),
(157, 1, 2, NULL, '2020-09-19 20:44:15', 'kasdhkjah\nalsjdalk\nadasdasdasd', 'saluuute', 'alsjdlkasjdlk\nslkjdlaksdj', '9494', '654654654', 505.1),
(158, 1, 1, NULL, '2020-10-14 19:55:12', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'ñlakdñlaskñdlkañlsdk', 30),
(159, 1, 1, NULL, '2020-10-14 20:58:17', 'te:', 'resultado', '1\n2\n3\n', 'diag', '654654', 30),
(160, 1, 1, NULL, '2020-10-16 17:56:23', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'asdasd', 30),
(161, 1, 1, NULL, '2020-10-16 18:14:52', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'ADAD', 30),
(162, 1, 1, NULL, '2020-10-16 18:33:22', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'ñdlkañlsdkalñsdk', 30),
(163, 1, 1, NULL, '2020-10-16 20:17:52', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'laksjdlkajsd', 30),
(164, 1, 1, NULL, '2020-10-16 20:53:52', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'aldjkasjdl', 30),
(165, 1, 1, NULL, '2020-10-16 21:15:55', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'alksjdlk', 30),
(166, 1, 1, NULL, '2020-10-16 21:27:32', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'alskdñalskd', 30),
(167, 1, 1, NULL, '2020-10-16 21:29:16', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'alksdjlaskjd', 30),
(168, 1, 1, NULL, '2020-10-16 21:31:09', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'alskdla', 30),
(169, 1, 1, NULL, '2020-10-16 21:33:15', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'alkjdsla', 30),
(170, 1, 1, NULL, '2020-10-16 21:41:45', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'Express da soporte a los siguientes métodos de direccionamiento que se corresponden con los métodos HTTP: get, post, put, head, delete, options, trace, copy, lock, mkcol, move, purge, propfind, proppatch, unlock, report, mkactivity, checkout, merge, m-search, notify, subscribe, unsubscribe, patch, search y connect.', 30),
(171, 1, 1, NULL, '2020-10-16 21:46:21', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'Express da soporte a los siguientes métodos de direccionamiento que se corresponden con los métodos HTTP: get, post, put, head, delete, options, trace, copy, lock, mkcol, move, purge, propfind, proppatch, unlock, report, mkactivity, checkout, merge, m-search, notify, subscribe, unsubscribe, patch, search y connect.Express da soporte a los siguientes métodos de direccionamiento que se corresponden con los métodos HTTP: get, post, put, head, delete, options, trace, copy, lock, mkcol, move, purge, propfind, proppatch, unlock, report, mkactivity, checkout, merge, m-search, notify, subscribe, unsubscribe, patch, search y connect.Express da soporte a los siguientes métodos de direccionamiento que se corresponden con los métodos HTTP: get, post, put, head, delete, options, trace, copy, lock, mkcol, move, purge, propfind, proppatch, unlock, report, mkactivity, checkout, merge, m-search, notify, subscribe, unsubscribe, patch, search y connect.', 30),
(172, 1, 1, NULL, '2020-10-16 22:00:51', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'Express da soporte a los siguientes métodos de direccionamiento que se corresponden con los métodos HTTP: get, post, put, head, delete, options, trace, copy, lock, mkcol, move, purge, propfind, proppatch, unlock, report, mkactivity, checkout, merge, m-search, notify, subscribe, unsubscribe, patch, search y connect.Express da soporte a los siguientes métodos de direccionamiento que se corresponden con los métodos HTTP: get, post, put, head, delete, options, trace, copy, lock, mkcol, move, purge, propfind, proppatch, unlock, report, mkactivity, checkout, merge, m-search, notify, subscribe, unsubscribe, patch, search y connect.Express da soporte a los siguientes métodos de direccionamiento que se corresponden con los métodos HTTP: get, post, put, head, delete, options, trace, copy, lock, mkcol, move, purge, propfind, proppatch, unlock, report, mkactivity, checkout, merge, m-search, notify, subscribe, unsubscribe, patch, search y connect.Express da soporte a los siguientes métodos de direccionamiento que se corresponden con los métodos HTTP: get, post, put, head, delete, options, trace, copy, lock, mkcol, move, purge, propfind, proppatch, unlock, report, mkactivity, checkout, merge, m-search, notify, subscribe, unsubscribe, patch, search y connect.', 30),
(173, 1, 1, NULL, '2020-10-16 22:04:12', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'Express da soporte a los siguientes métodos de direccionamiento que se corresponden con los métodos HTTP: get, post, put, head, delete, options, trace, copy, lock, mkcol, move, purge, propfind, proppatch, unlock, report, mkactivity, checkout, merge, m-search, notify, subscribe, unsubscribe, patch, search y connect.Express da soporte a los siguientes métodos de direccionamiento que se corresponden con los métodos HTTP: get, post, put, head, delete, options, trace, copy, lock, mkcol, move, purge, propfind, proppatch, unlock, report, mkactivity, checkout, merge, m-search, notify, subscribe, unsubscribe, patch, search y connect.Express da soporte a los siguientes métodos de direccionamiento que se corresponden con los métodos HTTP: get, post, put, head, delete, options, trace, copy, lock, mkcol, move, purge, propfind, proppatch, unlock, report, mkactivity, checkout, merge, m-search, notify, subscribe, unsubscribe, patch, search y connect.', 30),
(174, 1, 1, NULL, '2020-10-16 22:05:53', 'te:', 'resultado', '1\n2\n3\n', 'diag', 'Express da soporte a los siguientes métodos de direccionamiento que se corresponden con los métodos HTTP: get, post, put, head, delete, options, trace, copy, lock, mkcol, move, purge, propfind, proppatch, unlock, report, mkactivity, checkout, merge, m-search, notify, subscribe, unsubscribe, patch, search y connect.Express da soporte a los siguientes métodos de direccionamiento que se corresponden con los métodos HTTP: get, post, put, head, delete, options, trace, copy, lock, mkcol, move, purge, propfind, proppatch, unlock, report, mkactivity, checkout, merge, m-search, notify, subscribe, unsubscribe, patch, search y connect.Express da soporte a los siguientes métodos de direccionamiento que se corresponden con los métodos HTTP: get, post, put, head, delete, options, trace, copy, lock, mkcol, move, purge, propfind, proppatch, unlock, report, mkactivity, checkout, merge, m-search, notify, subscribe, unsubscribe, patch, search y connect.', 30);

--
-- Disparadores `historia_clinica`
--
DELIMITER $$
CREATE TRIGGER `cantidad_historia_usuario` AFTER INSERT ON `historia_clinica` FOR EACH ROW BEGIN
...
(5, 'Product updates you may have missed', 'Have you ever wondered where you can find our latest tutorials, announcements, news, videos and more? We just launched a new, dynamic page on our website that gives you an overview of all the activity happening across our channels, where to find the right resources, and how to interact with us.\r\nYou can now integrate the App Distribution iOS SDK into your test apps to alert testers when a new build is available to test.', '');
...
INSERT INTO `mensaje_usuario` (`Id_Mensaje_Usuario`, `Id_Usuario`, `Id_Mensaje`, `Leido`, `Fecha`, `createdAt`, `updatedAt`) VALUES
(1, 1, 1, 1, '2020-09-28 16:56:15', '0000-00-00 00:00:00', '2020-10-02 19:17:38'),
(2, 1, 2, 1, '2020-09-29 20:14:01', '0000-00-00 00:00:00', '2020-10-02 19:17:38'),
(3, 1, 3, 1, '2020-10-07 19:39:11', '0000-00-00 00:00:00', '2020-10-02 19:17:38'),
(4, 1, 4, 1, '2020-10-07 19:32:42', '0000-00-00 00:00:00', '2020-10-02 19:17:38'),
(5, 1, 5, 1, '2020-10-01 08:49:17', '0000-00-00 00:00:00', '2020-10-02 19:17:38'),
(6, 1, 4, 1, '0000-00-00 00:00:00', '2020-10-02 19:56:46', '2020-10-02 19:56:46');
...
(29, '54684888', 'KAROLINA', 'MAMANI', 'GONZALES', 'M', '1997-05-08', '925846446', '', 'PERUANA', 'ESTUDIANTE', 'ESTUDIANTE', 1),
(30, '46846488', 'JORGE ', 'BASADRE', 'GROOHMAN', 'F', '1997-08-15', '954888787', '', 'PERUANO', 'HISTORIADOR', 'ADA', 2),
(31, '84646546', 'KARLA', 'LAKSJDLAKSJ', 'ALSKDJLK', 'M', '1998-08-15', '68484684', '', 'PERUNA', 'AKSDJ', 'KASHKD', 1),
(32, '14848468', 'KAROLINA', 'LOMA', 'LAURA', 'M', '1995-05-15', '946846548', '', 'PERUANA', 'ESTUDIANTE', 'ASDAD', 1),
(33, '18468468', 'FRIDA', 'KALO', 'ASDAS', 'F', '1997-05-15', '948464684', '', 'PERUANA', 'OBRERO', 'ASDAD', 1),
(34, '49884878', 'JHON', 'ALVAREZ', 'VASQUEZ', 'M', '1998-08-15', '698484846', '', 'PERU', 'ASDAD', 'ASDASD', 1),
(36, '35465688', 'ORGA', 'ASLDKJALSKDJ', 'ASDASD', 'F', '1998-05-15', '684686486', '', '65468468', 'ASDKASJDL', 'ASLKDJLASD', 1),
(37, '65468468', 'FRESIA', 'RAMOS', 'ASD', 'M', '1995-08-15', '848798798', '', 'PERUANA', 'ASDASD', 'LKJALSKDA', 1),
(38, '66846888', 'KARIA', 'AASDA', 'ASDOAJ', 'F', '2008-08-15', '848468478', '', 'PERIADSHK', 'ASDA', 'ASDAD', 1),
(39, '68987984', 'CARLOS', 'ASLDKJ', 'LKASJDL', 'F', '1988-04-15', '498787987', '', 'PERU', 'ASDLJ', 'LAKSJDL', 1),
(40, '99878798', 'WALORPSO', 'ALKSDJALK', 'LKADSJLDK', 'M', '1998-04-15', '987984848', '', 'ALSKDJALKJ', 'ASLKDJL', 'AKSDJLKA', 1),
(41, '66879879', 'WALTER', 'ASDAl', 'KJLAS', 'M', '1988-08-15', '98798798', '', 'ASDA', 'ASDASD', 'ADASD', 1),
(42, '68468468', 'KAREN', 'ASLKDÑA', 'ÑLAKÑSDLK', 'M', '1997-08-15', '787987846', '', 'ASDASD', 'ASDASD', 'ASDASD', 1),
(43, '19988888', 'ESTEBAN', 'ASDASD', 'LKJLKJ', 'M', '1998-05-12', '648646846', '', 'ALKSDJALK', 'ASDA', 'LKJLKASD', 1),
(44, '46846848', 'HILARIO', 'ASDJLAKSJDL', 'LKJASD', 'M', '1998-05-12', '987648646', '', 'ALSKDJ', 'ASLDKJ', 'LKJASD', 1),
(45, '15848646', 'KARLOS', 'ADWWWWW', 'AWEEEEE', 'F', '1998-05-13', '948848888', '', 'PERUANO', 'LAKJSD', 'LKJALKSDJ', 1),
(46, '16848488', 'LEIDY', 'MONTES', 'MAMANI', 'M', '1995-05-12', '948588878', '', 'PERUANA', 'DESARROLLADORA', 'ALKSDJ', 1);
...
INSERT INTO `sugerencia` (`Id_Sugerencia`, `Titulo`, `Fecha`, `Leido`, `Descripcion`, `Id_Usuario`) VALUES
(1, '123456', '2020-10-11 18:39:27', 1, '1111', 1),
(2, '123456', '2020-10-11 18:51:52', 1, 'ajsdlkasjdlkajsldj', 1);
...
CREATE TABLE `usuario` (
  ...
  `Mensaje_Habilitado` tinyint(4) NOT NULL DEFAULT 1
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
INSERT INTO `usuario` (`Id_Usuario`, `Id_Doctor`, `Nombre`, `Password`, `Direccion`, `Direccion_IP`, `Ubicacion_GPS`, `Activo`, `Fecha_Activacion`, `Monto_Pago`, `Fecha_Habilitado`, `Fecha_Registro`, `Dia_Pago`, `Codigo_Web_Registro`, `Visualizo_Indicaciones`, `Tiempo_Atencion_Promedio`, `Precio_Predeterminado`, `Hora_Inicio_Atencion`, `Hora_Fin_Atencion`, `estado_perfil`, `imagen`, `Mensaje_Habilitado`) VALUES
(1, 1, 'alberth', '123456', NULL, NULL, NULL, 1, '2020-06-28 00:00:00.000', '30.00', '2020-10-21', NULL, '2020-08-05', NULL, NULL, NULL, NULL, NULL, NULL, 0, 'src/assets/media/images/profile/avatar1.png', 0),
(2, 2, 'jhon', '123456', 'Violetas, Calle Violetas Mz. C', NULL, NULL, 1, '2020-06-28 00:00:00.000', '105.10', NULL, NULL, '2020-04-15', NULL, NULL, 80, '4500.00', NULL, NULL, 0, 'src/assets/media/images/profile/20020905150546948615990417055139.png', 1),
(3, 9, 'jhonxdas123', '4eM9Jqb3yBVXD7D', 'Centro de tacna', NULL, NULL, 1, '2020-07-05 00:00:00.000', '25.00', '2020-07-05', '2020-07-05 19:12:17.000', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'src/assets/media/images/profile/avatar1.png', 1),
(4, 10, 'ericksolitario', 'B4NHL32da7v8zSa', 'Fuera de la catedral', NULL, NULL, 1, '2020-07-05 00:00:00.000', '50.00', '2020-07-05', '2020-07-05 19:18:14.000', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'src/assets/media/images/profile/avatar1.png', 1),
(5, 11, 'ruthlapanda', 'g78WWQhKrihsPjJ', 'en la plaza zela', NULL, NULL, 1, '2020-07-05 00:00:00.000', '150.00', '2020-07-05', '2020-07-05 19:32:23.000', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'src/assets/media/images/profile/avatar1.png', 1),
(6, 12, 'ronaldo456', 'MFzc6Km7c5sC6y4', 'av', NULL, NULL, 1, '2020-08-18 00:00:00.000', '80.00', '2020-08-18', '2020-08-18 21:42:00.000', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'src/assets/media/images/profile/avatar1.png', 1),
(7, 13, 'RONALDIÑO123', 'wU5Zpgv9QSRzpAE', 'AV', NULL, NULL, 1, '2020-08-19 00:00:00.000', '100.00', '2020-08-19', '2020-08-19 23:15:07.000', '1998-01-15', NULL, NULL, NULL, NULL, NULL, NULL, 0, 'src/assets/media/images/profile/0819201115531597893353.4744.png', 1);
...
`id` int(11)
,`name_archivo` varchar(250)
,`link` varchar(500)
,`ar_size` float
,`fecha_subido` varchar(19)
,`tipo` int(11)
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_detalle_historia`  AS  select `hc`.`Id_historia_clinica` AS `id`,concat(`pa`.`Nombre`,' ',`pa`.`Apellido_Paterno`,' ',`pa`.`Apellido_Materno`) AS `nombres`,`pa`.`Documento` AS `dni`,`pa`.`Genero` AS `genero`,`pa`.`Celular` AS `celular`,date_format(`pa`.`Fecha_Nacimiento`,'%d/%m/%Y') AS `fn`,`pa`.`Email` AS `email`,`pa`.`Procedencia` AS `procedencia`,`pa`.`Fecha_Nacimiento` AS `edad`,date_format(`hc`.`Fecha`,'%d/%m/%Y %h:%i:%s') AS `fecha_historia`,`hc`.`Diagnostico` AS `diag`,`hc`.`Examen_Fisico` AS `ex_fi`,`hc`.`Anamnesis` AS `anam`,`hc`.`Examenes` AS `exam`,date_format(`ci`.`Fecha_Creacion`,'%d/%m/%Y %h:%i:%s') AS `fcreacion`,date_format(`ci`.`Fecha_Cita`,'%d/%m/%Y %h:%i %p') AS `fcita`,`ci`.`Estado` AS `estado`,`ci`.`Atencion` AS `atencion`,`hc`.`Monto` AS `precio`,`hc`.`Tratamiento` AS `tratamiento`,(select count(`ar`.`Id_Archivo`) from `archivo` `ar` where `ar`.`Id_Historia_Clinica` = `hc`.`Id_historia_clinica` and (`ar`.`Id_Tipo_Archivo` = 1 or `ar`.`Id_Tipo_Archivo` = 2)) AS `count_image`,(select count(`ar`.`Id_Archivo`) from `archivo` `ar` where `ar`.`Id_Historia_Clinica` = `hc`.`Id_historia_clinica` and `ar`.`Id_Tipo_Archivo` = 3) AS `count_pdf`,(select count(`ar`.`Id_Archivo`) from `archivo` `ar` where `ar`.`Id_Historia_Clinica` = `hc`.`Id_historia_clinica` and `ar`.`Id_Tipo_Archivo` = 4) AS `count_doc`,`us`.`Nombre` AS `username` from (((`historia_clinica` `hc` join `paciente` `pa` on(`pa`.`Id_Paciente` = `hc`.`Id_Paciente`)) left join `citas` `ci` on(`ci`.`Id_Citas` = `hc`.`Id_Cita`)) join `usuario` `us` on(`us`.`Id_Usuario` = `hc`.`Id_Usuario`)) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_lista_archivo`  AS  select `ar`.`Id_Archivo` AS `id`,`ar`.`Subnombre` AS `name_archivo`,`ar`.`Enlace` AS `link`,`ar`.`Size` AS `ar_size`,date_format(`ar`.`FechaCreado`,'%d/%m/%Y %h:%i:%s') AS `fecha_subido`,`ta`.`Id_Tipo_Archivo` AS `tipo`,`ta`.`Nombre` AS `tipo_archivo`,`ar`.`Id_Historia_Clinica` AS `Id_Historia_Clinica`,`us`.`Nombre` AS `username` from ((`archivo` `ar` left join `tipo_archivo` `ta` on(`ta`.`Id_Tipo_Archivo` = `ar`.`Id_Tipo_Archivo`)) join `usuario` `us` on(`us`.`Id_Usuario` = `ar`.`CreadoPor`)) where `ar`.`Borrado` = 0 ;
...
--
ALTER TABLE `archivo`
  MODIFY `Id_Archivo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=169;

--
-- AUTO_INCREMENT de la tabla `ayuda`
--
ALTER TABLE `ayuda`
  MODIFY `Id_Ayuda` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `detalle_cuestionario`
  MODIFY `Id_Detalle_Cuestionario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=146;

--
-- AUTO_INCREMENT de la tabla `detalle_cuestionario_paciente`
--
ALTER TABLE `detalle_cuestionario_paciente`
  MODIFY `Id_Cuestionario_Paciente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=352;
...
--
ALTER TABLE `historia_clinica`
  MODIFY `Id_historia_clinica` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=175;
...
--
ALTER TABLE `mensaje_usuario`
  MODIFY `Id_Mensaje_Usuario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
