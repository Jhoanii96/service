...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-09-2020 a las 23:43:59
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `actualizar_perfil_cuenta` (IN `email` VARCHAR(200), IN `link_image` VARCHAR(250), IN `username` VARCHAR(60), IN `isnotimage` VARCHAR(1))  BEGIN 
...
(2, 2, 'jhon', '123456', 'Violetas, Calle Violetas Mz. C', NULL, NULL, 1, '2020-06-28 00:00:00.000', '20.00', NULL, NULL, '2020-04-15', NULL, NULL, 80, '4500.00', NULL, NULL, 0, 'src/assets/media/images/profile/20020905150546948615990417055139.png'),
...
--
ALTER TABLE `historia_clinica`
  MODIFY `Id_historia_clinica` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=154;
